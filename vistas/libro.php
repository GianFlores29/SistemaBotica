              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Productos <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar Producto</button></h1>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="date" class="form-control" name="year_edicion" id="year_edicion" required>
                          </div>
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <label>Almacen:</label>
                        ...
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="decimal" class="form-control" name="numero_paginas" id="numero_paginas" required>
                        </div>
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Precio Venta:</label>
                            <input type="decimal" class="form-control" name="formato" id="formato" maxlength="50">
                        </div>
                        <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Formato:</label>
